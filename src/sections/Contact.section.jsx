...
const ContactSection = ({ className }) => {
	return (
		...
		>
			...
			<div className="order-2 flex-grow bg-white text-indigo-600 py-40 md:py-0 flex flex-col xs:justify-center xs:items-center px-8 xs:px-12 text-md font-medium">
				<div>
					<OpenHours />
